        ...
        <div className="portfolio-container flex flex-col md:flex-row gap-10 md:px-30 px-10 justify-center items-center">
          ...
          >
            ...
            <div className="content px-4 py-3 space-y-4">
              <h2 className="font-bold text-2xl">AI landing page</h2>
              <div className="langauage space-x-1.5">
                ...
                <span className="border-2 px-3 font-semibold  bg-[#fdc4482c] rounded-xl"style={{ borderColor: "#FDC448" }}>tailwind</span>
                <span className="border-2 px-3 font-semibold  bg-[#fdc4482c] rounded-xl"style={{ borderColor: "#FDC448" }}>JS</span>
              </div>
              <a href="https://robot-ai-website-oibs.vercel.app/" target="_blank">
          ...
          >
            ...
            <div className="content px-4 py-3 space-y-4">
              <h2 className="font-bold text-2xl">E-commerce Website</h2>
              <div className="langauage space-x-1.5">
                <span className="border-2 px-3 font-semibold  bg-[#fdc4482c] rounded-xl"style={{ borderColor: "#FDC448" }}>React js</span>
              ...
              <a href="https://e-commerce-web-flax.vercel.app/"target="_blank">
              <button
                data-aos="zoom-in"
                type="submit"
                value="Send"
          ...
          >
            ...
            <div className="content px-4 py-3 space-y-4">
              <h2 className="font-bold text-2xl">Food delivery website</h2>
              <div className="langauage space-x-1.5">
              ...
              <a href="https://food-website-5287.vercel.app/" target="_blank">
              <button
                data-aos="zoom-in"
                type="submit"
                value="Send"
